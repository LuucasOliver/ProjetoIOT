...
const char* ssid = "54321";  // Entre SSID aqui
const char* password = "12345678";  // Insira a senha aqui
WebServer server(80);
// Sensor DHT
uint8_t DHTPin = 4; 
...
String SendHTML(float Temperaturestat,float Humiditystat){
  ...
  ptr +="<title>Temperatura e Humidade ESP32</title>\n";
  ...
  ptr +="<body>\n";
  ptr +="<div id=\"webpage\">\n";
  ptr +="<h1>Temperatura e Humidade ESP32</h1>\n";
